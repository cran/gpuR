...
test_that("CPU vclMatrix Single Precision Matrix second matrix inversion",
          {
...
test_that("CPU vclMatrix Double Precision Matrix second matrix inversion", 
          {
