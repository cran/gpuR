library(gpuR)
context("CPU gpuMatrix svd decomposition")
...
test_that("CPU gpuMatrix Single Precision Matrix SVD Decomposition",
          {
...
test_that("CPU gpuMatrix Double Precision Matrix SVD Decomposition", 
          {
