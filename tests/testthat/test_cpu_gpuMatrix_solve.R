...
test_that("CPU gpuMatrix Single Precision Matrix Square Matrix Inversion",
          {
...
test_that("CPU gpuMatrix Single Precision Matrix second matrix inversion",
          {
...
test_that("CPU gpuMatrix Single Precision Matrix non-identity solve",
          {
...
test_that("CPU gpuMatrix Double Precision Matrix Square Matrix Inversion",
          {
...
test_that("CPU gpuMatrix Double Precision Matrix second matrix inversion",
          {
...
test_that("CPU gpuMatrix Double Precision Matrix non-identity solve",
          {
...
test_that("CPU gpuMatrix Integer Inversion not supported",
          {
