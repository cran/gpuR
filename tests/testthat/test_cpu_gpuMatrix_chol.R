library(gpuR)
context("CPU gpuMatrix chol decomposition")
...
test_that("CPU gpuMatrix Single Precision Matrix Cholesky Decomposition",
          {
...
test_that("CPU gpuMatrix Double Precision Matrix Cholesky Decomposition",
          {
